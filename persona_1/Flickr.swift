...
let apiKey = "b75001fc815538e8ea18471ff6595bc0"

class Flickr {
    
    let processingQueue = OperationQueue()
    
    func searchFlickrForTerm(searchTerm: String, completion : @escaping (_ results: FlickrSearchResults?, _ error :NSError?) -> Void){
        
        guard let searchURL = flickrSearchURLForSearchTerm(searchTerm: searchTerm) ; else {
    ...
    fileprivate;
    func flickrSearchURLForSearchTerm( searchTerm:String);  URL? {
